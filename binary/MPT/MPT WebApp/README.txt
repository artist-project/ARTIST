...
5. The deployment of the MPT WebApp (Tomcat v7 recommended - for installing Tomcat please follow instruction in official website) can be done manually by copying the eu.artist.methodology.mpt.webapp.war to Tomcat's 'webapps' directory or by following instructions through Tomcat's Manager GUI.
