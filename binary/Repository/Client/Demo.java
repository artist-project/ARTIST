...
public class Demo {
	...
	private void run() throws FileNotFoundException {
		...
		ProjectName useCase = ProjectName.of("useCase.dews");
		projects.create(useCase, "DEWS", "DEWS use case");
		...
		RepoArtefact pricingProfile = new RepoArtefact.Builder(profileId)
				...
				.build();
		artefacts.delete(useCase, pricingProfile.getArtefactId());
		artefacts.create(useCase, pricingProfile);
		...
		Optional<RepoArtefact> retrieved = artefacts.get(useCase, profileId);
		...
		artefacts.delete(useCase, model1.getArtefactId());
		printArtefact(artefacts.create(useCase, model1));
		...
		artefacts.delete(useCase, model2.getArtefactId());
		printArtefact(artefacts.create(useCase, model2));
