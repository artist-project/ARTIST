...
public class CommunicationsPackageImpl extends EPackageImpl implements CommunicationsPackage {
	 ...
	 * @see org.modelexecution.fuml.Syntax.CommonBehaviors.Communications.CommunicationsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		triggerEClass.getESuperTypes().add(theKernelPackage.getNamedElement());
		eventEClass.getESuperTypes().add(theKernelPackage.getPackageableElement());
		signalEClass.getESuperTypes().add(theKernelPackage.getClassifier());
		signalEventEClass.getESuperTypes().add(this.getMessageEvent());
		messageEventEClass.getESuperTypes().add(this.getEvent());
		receptionEClass.getESuperTypes().add(theKernelPackage.getBehavioralFeature());
		...
		initEReference(getSignal_OwnedAttribute(), theKernelPackage.getProperty(), null, "ownedAttribute", null, 0, -1, Signal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
