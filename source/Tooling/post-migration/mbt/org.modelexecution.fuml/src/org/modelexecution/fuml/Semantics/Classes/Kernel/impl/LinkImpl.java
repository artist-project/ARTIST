 ...
 * <ul>
 *   <li>{@link org.modelexecution.fuml.Semantics.Classes.Kernel.impl.LinkImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LinkImpl extends ExtensionalValueImpl implements Link {
	/**
	...
	protected EClass eStaticClass() {
		return KernelPackage.Literals.LINK;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KernelPackage.LINK__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Association newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelPackage.LINK__TYPE, oldType, type));
	}
