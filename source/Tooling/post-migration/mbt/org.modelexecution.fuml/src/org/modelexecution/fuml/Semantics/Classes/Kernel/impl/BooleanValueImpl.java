 ...
 * <ul>
 *   <li>{@link org.modelexecution.fuml.Semantics.Classes.Kernel.impl.BooleanValueImpl#isValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanValueImpl extends PrimitiveValueImpl implements BooleanValue {
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelPackage.BOOLEAN_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KernelPackage.BOOLEAN_VALUE__VALUE:
				return isValue();
		}
