 ...
 * <ul>
 *   <li>{@link org.modelexecution.fuml.Syntax.CommonBehaviors.Communications.impl.SignalEventImpl#getSignal <em>Signal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SignalEventImpl extends MessageEventImpl implements SignalEvent {
	...
	protected EClass eStaticClass() {
		return CommunicationsPackage.Literals.SIGNAL_EVENT;
	}
		...
		if (signal != null && signal.eIsProxy()) {
			...
			if (signal != oldSignal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CommunicationsPackage.SIGNAL_EVENT__SIGNAL, oldSignal, signal));
			}
		}
		return signal;
	}
	...
	public void setSignal(Signal newSignal) {
		...
		signal = newSignal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommunicationsPackage.SIGNAL_EVENT__SIGNAL, oldSignal, signal));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommunicationsPackage.SIGNAL_EVENT__SIGNAL:
