...
//				"platform:/resource/eu.artist.postmigration.nfrvt.lang.nsl/model/generated/NSL.genmodel");
	 ...
	 * the generated EPackage and the GenModelFile.
	 */
	protected static XtextLanguageUnit PML_UNIT = new XtextLanguageUnit();
	static {
		PML_UNIT = new XtextLanguageUnit();
		PML_UNIT.addNsUri("http://www.artist.eu/postmigration/nfrvt/lang/pml/PML");		
		PML_UNIT.addGeneratedEPackage("eu.artist.postmigration.nfrvt.lang.pml.pml.PmlPackage");
		PML_UNIT.addGenModelFile("platform:/resource/eu.artist.postmigration.nfrvt.lang.pml/model/generated/PML.genmodel");
	}
