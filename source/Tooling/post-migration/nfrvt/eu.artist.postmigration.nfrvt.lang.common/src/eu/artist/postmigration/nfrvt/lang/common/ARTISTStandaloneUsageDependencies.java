...
//	private boolean esl;
	...
	/**
	 * Return true if the {@link XtextLanguageUnit#PML_UNIT} unit
	 * is added in this setup, false otherwise.
	 * @return true if the {@link XtextLanguageUnit#PML_UNIT} unit
	 * is added in this setup, false otherwise.
	 */
	...
	/**
	 * Adds/Removes the {@link XtextLanguageUnit#PML_UNIT} unit 
	 * to/from this setup.
	 * @param nsl if true, the necessary dependencies will be added.
	 */
	public void setPml(boolean pml) {
		this.pml = pml;
	}
...
//			mappings.addAll(XtextLanguageUnit.ESL_UNIT.getUriMappings());
		if(isPml())
			mappings.addAll(XtextLanguageUnit.PML_UNIT.getUriMappings());
		if(isGml())
...
//			mappings.addAll(XtextLanguageUnit.ESL_UNIT.getGeneratedEPackages());
		if(isPml())
			mappings.addAll(XtextLanguageUnit.PML_UNIT.getGeneratedEPackages());
		if(isGml())
...
//			mappings.addAll(XtextLanguageUnit.ESL_UNIT.getGenModelFiles());
		if(isPml())
			mappings.addAll(XtextLanguageUnit.PML_UNIT.getGenModelFiles());
		if(isGml())
