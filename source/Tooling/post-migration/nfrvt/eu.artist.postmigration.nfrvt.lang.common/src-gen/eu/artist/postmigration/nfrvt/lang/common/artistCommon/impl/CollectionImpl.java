 ...
 * <ul>
 *   <li>{@link eu.artist.postmigration.nfrvt.lang.common.artistCommon.impl.CollectionImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollectionImpl extends MinimalEObjectImpl.Container implements Collection
{
  ...
  {
    return ArtistCommonPackage.Literals.COLLECTION;
  }
  ...
  public EList<ValueSpecification> getValues()
  {
    if (values == null)
    {
      values = new EObjectContainmentEList<ValueSpecification>(ValueSpecification.class, this, ArtistCommonPackage.COLLECTION__VALUES);
    }
    return values;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ArtistCommonPackage.COLLECTION__VALUES:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case ArtistCommonPackage.COLLECTION__VALUES:
        getValues().clear();
        getValues().addAll((java.util.Collection<? extends ValueSpecification>)newValue);
        return;
    }
