...
public class CollectiveProgressListener extends AbstractProgressListener implements ProgressListener {
	...
	private ISolutionPrinter<? extends Solution> printer;
	...
	public ISolutionPrinter<? extends Solution> getSolutionPrinter() {
		return printer;
	}
	
	public CollectiveProgressListener setSolutionPrinter(ISolutionPrinter<? extends Solution> printer) {
	...
	public CollectiveProgressListener setSolutionPrinter(ISolutionPrinter<? extends Solution> printer, boolean printSimpleAggregate, boolean printObjectives, boolean printConstraints) {
	...
	public abstract class SolutionColumn<S extends Solution> implements IColumn {
		protected ISolutionPrinter<S> printer;
		protected S solution;
		protected int index;

		public SolutionColumn(S solution, int index, ISolutionPrinter<S> printer) {
