...
public class FUMLSimulationProcess extends PlatformObject implements IProcess {

	private ILaunch launch;
	private InternalFUMLSimulationProcess internalProcess;
	private String name;
	...
	public FUMLSimulationProcess(ILaunch launch, Process process, String name,
	...
	private void setFields(ILaunch launch, Process process, String name,
			@SuppressWarnings("rawtypes") Map attributes) {
		this.launch = launch;
		assertInternalFUMLSimulationProcess(process);
		this.internalProcess = (InternalFUMLSimulationProcess) process;
		launch.addProcess(this);
		this.name = name;
		this.attributes = attributes;
	}

	private void assertInternalFUMLSimulationProcess(Process process) {
		Assert.isTrue(process instanceof InternalFUMLSimulationProcess);
	}
	...
	public int getExitValue() throws DebugException {
		return InternalFUMLSimulationProcess.EXIT_VALUE;
	}
