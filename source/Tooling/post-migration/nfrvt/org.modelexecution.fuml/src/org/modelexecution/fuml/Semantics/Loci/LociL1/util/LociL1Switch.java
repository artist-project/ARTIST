/**
 */
package org.modelexecution.fuml.Semantics.Loci.LociL1.util;
 ...
 * @generated
 */
public class LociL1Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static LociL1Package modelPackage;
	...
	public LociL1Switch() {
		if (modelPackage == null) {
			modelPackage = LociL1Package.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LociL1Package.SEMANTIC_VISITOR: {
				SemanticVisitor semanticVisitor = (SemanticVisitor)theEObject;
				T result = caseSemanticVisitor(semanticVisitor);
