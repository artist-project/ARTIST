 ...
 * @generated
 */
public class CommunicationsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CommunicationsPackage.TRIGGER: {
			...
			case CommunicationsPackage.EVENT: {
			...
			case CommunicationsPackage.SIGNAL: {
			...
			case CommunicationsPackage.SIGNAL_EVENT: {
			...
			case CommunicationsPackage.MESSAGE_EVENT: {
			...
			case CommunicationsPackage.RECEPTION: {
