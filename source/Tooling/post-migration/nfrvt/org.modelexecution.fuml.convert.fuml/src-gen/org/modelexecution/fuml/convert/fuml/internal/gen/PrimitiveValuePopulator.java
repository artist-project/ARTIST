...
public class PrimitiveValuePopulator implements IValuePopulator {
	...
	public void populate(Object fumlElement,
		...
		if (!(fumlElement_ instanceof org.modelexecution.fuml.Semantics.Classes.Kernel.PrimitiveValue) ||
			!(fumlElement instanceof fUML.Semantics.Classes.Kernel.PrimitiveValue)) {
			return;
		}
