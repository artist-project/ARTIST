...
public class CompoundValuePopulator implements IValuePopulator {
	...
	public void populate(Object fumlElement,
		...
		if (!(fumlElement_ instanceof org.modelexecution.fuml.Semantics.Classes.Kernel.CompoundValue) ||
			!(fumlElement instanceof fUML.Semantics.Classes.Kernel.CompoundValue)) {
			return;
		}
		...
		for (org.modelexecution.fuml.Semantics.Classes.Kernel.FeatureValue value : fumlNamedElement_.getFeatureValues()) {
					fumlNamedElement.featureValues.add((fUML.Semantics.Classes.Kernel.FeatureValue) valueConversionResult.getFUMLElement(value));
		}
