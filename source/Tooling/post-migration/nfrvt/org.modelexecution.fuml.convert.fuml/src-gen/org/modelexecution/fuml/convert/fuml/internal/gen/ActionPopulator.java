...
public class ActionPopulator implements IElementPopulator {
	...
	public void populate(fUML.Syntax.Classes.Kernel.Element fumlElement,
		...
		if (!(fumlElement_ instanceof org.modelexecution.fuml.Syntax.Actions.BasicActions.Action) ||
		...
		org.modelexecution.fuml.Syntax.Actions.BasicActions.Action fumlNamedElement_ = (org.modelexecution.fuml.Syntax.Actions.BasicActions.Action) fumlElement_;
		
		
		for (org.modelexecution.fuml.Syntax.Actions.BasicActions.OutputPin value : fumlNamedElement_.getOutput()) {
					fumlNamedElement.output.add((fUML.Syntax.Actions.BasicActions.OutputPin) result.getFUMLElement(value));
		}
		
		fumlNamedElement.context = (fUML.Syntax.Classes.Kernel.Classifier) result.getFUMLElement(fumlNamedElement_.getContext());
		
		for (org.modelexecution.fuml.Syntax.Actions.BasicActions.InputPin value : fumlNamedElement_.getInput()) {
					fumlNamedElement.input.add((fUML.Syntax.Actions.BasicActions.InputPin) result.getFUMLElement(value));
		}
		
		fumlNamedElement.isLocallyReentrant = fumlNamedElement_.isLocallyReentrant();
