...
public class BooleanValuePopulator implements IValuePopulator {
	...
	public void populate(Object fumlElement,
		...
		if (!(fumlElement_ instanceof org.modelexecution.fuml.Semantics.Classes.Kernel.BooleanValue) ||
			!(fumlElement instanceof fUML.Semantics.Classes.Kernel.BooleanValue)) {
			return;
		}
