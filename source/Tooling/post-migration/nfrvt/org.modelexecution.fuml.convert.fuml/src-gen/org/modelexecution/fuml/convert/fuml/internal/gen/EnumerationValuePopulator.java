...
public class EnumerationValuePopulator implements IValuePopulator {
	...
	public void populate(Object fumlElement,
		...
		if (!(fumlElement_ instanceof org.modelexecution.fuml.Semantics.Classes.Kernel.EnumerationValue) ||
			!(fumlElement instanceof fUML.Semantics.Classes.Kernel.EnumerationValue)) {
			return;
		}
		...
		fumlNamedElement.type = (fUML.Syntax.Classes.Kernel.Enumeration) result.getFUMLElement(fumlNamedElement_.getType());
