 ...
 *******************************************************************************/
package eu.artist.postmigration.nfrvt.lang.esl.serializer;
...
public class ESLSemanticSequencer extends ARTISTCommonSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		...
		else if(semanticObject.eClass().getEPackage() == EslPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case EslPackage.EVALUATION_STRATEGY:
				if(context == grammarAccess.getEvaluationStrategyRule()) {
					sequence_EvaluationStrategy(context, (EvaluationStrategy) semanticObject); 
					return; 
				}
				else break;
			case EslPackage.EVALUATION_STRATEGY_CATALOGUE:
				if(context == grammarAccess.getEvaluationStrategyCatalogueRule()) {
					sequence_EvaluationStrategyCatalogue(context, (EvaluationStrategyCatalogue) semanticObject); 
					return; 
				}
				else break;
			}
	...
	/**
	 * Constraint:
	 *     (imports+=ImportNamespace* name=QualifiedName strategies+=EvaluationStrategy*)
	 */
	protected void sequence_EvaluationStrategyCatalogue(EObject context, EvaluationStrategyCatalogue semanticObject) {
	 ...
	 *     (
	 *         name=ID 
	 *         javaClass=[JvmDeclaredType|QualifiedName]? 
	 *         description=STRING 
	 *         level=EvaluationStrategyLevelKind 
	 *         properties+=[QuantitativeProperty|QualifiedName] 
	 *         properties+=[QuantitativeProperty|QualifiedName]*
	 *     )
	 */
