...
entryRuleEvaluationStrategyCatalogue returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getEvaluationStrategyCatalogueRule()); }
	 ...
	 { $current=$iv_ruleEvaluationStrategyCatalogue.current; } 
	 EOF 
;

// Rule EvaluationStrategyCatalogue
ruleEvaluationStrategyCatalogue returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
ruleEvaluationStrategyLevelKind returns [Enumerator current=null] 
    @init { enterRule(); }
    @after { leaveRule(); }:
((	enumLiteral_0='model' 
	{
