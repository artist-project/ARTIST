...
public class MigrationExplorerProcess extends PlatformObject implements IProcess {

	private ILaunch launch;
	private InternalMigrationExplorerProcess internalProcess;
	private String name;
	...
	public MigrationExplorerProcess(ILaunch launch, Process process, String name,
	...
	private void setFields(ILaunch launch, Process process, String name,
		...
		this.internalProcess = (InternalMigrationExplorerProcess) process;
	...
	private void assertEvaluationProcess(Process process) {
		Assert.isTrue(process instanceof InternalMigrationExplorerProcess);
	}
	...
	public int getExitValue() throws DebugException {
		return InternalMigrationExplorerProcess.EXIT_VALUE;
	}
