...
public class AnalysisSettingsTab extends AbstractLaunchConfigurationTab {
	...
	public void performApply(ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(MigrationExplorerActivator.ATT_QN_RESULT_PATH, uriText
				.getText().trim());
		configuration.setAttribute(MigrationExplorerActivator.ATT_QN_SIMULATION_TIME,
				""+getSimulationTime());
	}
