...
public class ServiceCentersThroughputPrinter extends AbstractServiceCentersPropertyPrinter {

	public ServiceCentersThroughputPrinter(char separator, List<Service> services) {
		super(separator, services);
	}

	@Override
	protected void printPropertyValue(StringBuilder builder, Service service, Range range) {
		printWithSeparator(builder, service.throughput(range));
	}
}
