...
public class ServiceCentersIdleTimePrinter extends AbstractServiceCentersPropertyPrinter {

	public ServiceCentersIdleTimePrinter(char separator, List<Service> services) {
		super(separator, services);
	}

	@Override
	protected void printPropertyValue(StringBuilder builder, Service service, Range range) {
		printWithSeparator(builder, service.idleTime(range));
	}
}
