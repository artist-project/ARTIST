...
public class ServiceCentersMaxQueueLengthPrinter extends AbstractServiceCentersPropertyPrinter {

	public ServiceCentersMaxQueueLengthPrinter(char separator, List<Service> services) {
		super(separator, services);
	}

	@Override
	protected void printPropertyValue(StringBuilder builder, Service service, Range range) {
		printWithSeparator(builder, service.maxQueueLength(range));
	}
}
