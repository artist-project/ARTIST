...
public class GoalAnalysisMultiFitnessFunction extends ScenarioAnalysisMultiFitnessFunction {

	private GoalModel goals;
	private double penaltyFactor = 1.0;
	
	public GoalAnalysisMultiFitnessFunction(
	...
	public GoalAnalysisMultiFitnessFunction(ScenarioAnalysis analysis,
			GoalModel goals) {
		super(analysis);
		this.goals = goals;
	}
	...
	protected void initObjectiveDimensions() {		
		...
		addObjective(new AbstractFitnessDimension<PatternSelectionSolution>(
				PatternSelectionSolution.class, "Utilization") {
			@Override
			public double evaluate(PatternSelectionSolution solution) {
				return getUtilizationDifference();
			}
		...
		addObjective(new AbstractFitnessDimension<PatternSelectionSolution>(
				PatternSelectionSolution.class, "RunTimePerRequest") {
			@Override
			public double evaluate(PatternSelectionSolution solution) {
				return getResponseTimeDifference();
			}
