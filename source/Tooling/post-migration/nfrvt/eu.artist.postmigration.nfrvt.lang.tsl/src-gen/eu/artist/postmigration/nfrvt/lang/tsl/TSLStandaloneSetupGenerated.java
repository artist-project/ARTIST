...
public class TSLStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.artist.eu/postmigration/nfrvt/lang/tsl/TSL")) {
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("optpat", resourceFactory);
		org.eclipse.xtext.resource.IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("optpat", serviceProvider);
