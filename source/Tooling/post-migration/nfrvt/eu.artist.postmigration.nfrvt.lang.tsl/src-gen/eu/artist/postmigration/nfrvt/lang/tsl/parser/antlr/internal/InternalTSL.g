...
ruleARTISTModel returns [EObject current=null] 
    ...
    { 
        $current = $this_PatternCatalogue_0.current; 
...
entryRulePatternCatalogue returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getPatternCatalogueRule()); }
	 iv_rulePatternCatalogue=rulePatternCatalogue 
	 { $current=$iv_rulePatternCatalogue.current; } 
	 EOF 
;

// Rule PatternCatalogue
rulePatternCatalogue returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRulePatternImpact returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getPatternImpactRule()); }
	 iv_rulePatternImpact=rulePatternImpact 
	 { $current=$iv_rulePatternImpact.current; } 
	 EOF 
;

// Rule PatternImpact
rulePatternImpact returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
