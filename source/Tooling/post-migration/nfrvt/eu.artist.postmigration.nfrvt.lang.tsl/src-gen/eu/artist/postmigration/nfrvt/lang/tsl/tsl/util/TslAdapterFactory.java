...
public class TslAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected TslSwitch<Adapter> modelSwitch =
    new TslSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter casePatternImpact(PatternImpact object)
      {
        return createPatternImpactAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link eu.artist.postmigration.nfrvt.lang.tsl.tsl.PatternCatalogue <em>Pattern Catalogue</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link eu.artist.postmigration.nfrvt.lang.tsl.tsl.Pattern <em>Pattern</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link eu.artist.postmigration.nfrvt.lang.tsl.tsl.PatternImpact <em>Pattern Impact</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createPatternImpactAdapter()
  {
    return null;
  }
