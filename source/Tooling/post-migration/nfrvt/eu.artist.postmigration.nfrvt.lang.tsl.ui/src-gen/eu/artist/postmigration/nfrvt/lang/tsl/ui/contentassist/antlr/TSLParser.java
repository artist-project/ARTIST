...
* generated by Xtext
*/
package eu.artist.postmigration.nfrvt.lang.tsl.ui.contentassist.antlr;
...
public class TSLParser extends AbstractContentAssistParser {
	...
	@Override
	protected eu.artist.postmigration.nfrvt.lang.tsl.ui.contentassist.antlr.internal.InternalTSLParser createParser() {
		eu.artist.postmigration.nfrvt.lang.tsl.ui.contentassist.antlr.internal.InternalTSLParser result = new eu.artist.postmigration.nfrvt.lang.tsl.ui.contentassist.antlr.internal.InternalTSLParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPatternCatalogueAccess().getGroup(), "rule__PatternCatalogue__Group__0");
					...
					put(grammarAccess.getPatternAccess().getGroup_11_4(), "rule__Pattern__Group_11_4__0");
					put(grammarAccess.getPatternAccess().getGroup_12(), "rule__Pattern__Group_12__0");
					put(grammarAccess.getPatternAccess().getGroup_12_4(), "rule__Pattern__Group_12_4__0");
					put(grammarAccess.getPatternAccess().getGroup_13(), "rule__Pattern__Group_13__0");
					put(grammarAccess.getPatternAccess().getGroup_13_4(), "rule__Pattern__Group_13_4__0");
					put(grammarAccess.getPatternImpactAccess().getGroup(), "rule__PatternImpact__Group__0");
					...
					put(grammarAccess.getPatternCatalogueAccess().getImportsAssignment_0(), "rule__PatternCatalogue__ImportsAssignment_0");
					put(grammarAccess.getPatternCatalogueAccess().getNameAssignment_2(), "rule__PatternCatalogue__NameAssignment_2");
					put(grammarAccess.getPatternCatalogueAccess().getPatternsAssignment_4(), "rule__PatternCatalogue__PatternsAssignment_4");
					put(grammarAccess.getPatternAccess().getNameAssignment_1(), "rule__Pattern__NameAssignment_1");
					put(grammarAccess.getPatternAccess().getContextAssignment_4(), "rule__Pattern__ContextAssignment_4");
					put(grammarAccess.getPatternAccess().getProblemAssignment_7(), "rule__Pattern__ProblemAssignment_7");
					put(grammarAccess.getPatternAccess().getSolutionAssignment_10(), "rule__Pattern__SolutionAssignment_10");
					put(grammarAccess.getPatternAccess().getPropertyImpactsAssignment_11_3(), "rule__Pattern__PropertyImpactsAssignment_11_3");
					put(grammarAccess.getPatternAccess().getPropertyImpactsAssignment_11_4_1(), "rule__Pattern__PropertyImpactsAssignment_11_4_1");
					put(grammarAccess.getPatternAccess().getPatternImpactsAssignment_12_3(), "rule__Pattern__PatternImpactsAssignment_12_3");
					put(grammarAccess.getPatternAccess().getPatternImpactsAssignment_12_4_1(), "rule__Pattern__PatternImpactsAssignment_12_4_1");
					put(grammarAccess.getPatternAccess().getRelatedPatternsAssignment_13_3(), "rule__Pattern__RelatedPatternsAssignment_13_3");
					put(grammarAccess.getPatternAccess().getRelatedPatternsAssignment_13_4_1(), "rule__Pattern__RelatedPatternsAssignment_13_4_1");
					put(grammarAccess.getPatternImpactAccess().getTargetAssignment_0(), "rule__PatternImpact__TargetAssignment_0");
					put(grammarAccess.getPatternImpactAccess().getImpactAssignment_1(), "rule__PatternImpact__ImpactAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			eu.artist.postmigration.nfrvt.lang.tsl.ui.contentassist.antlr.internal.InternalTSLParser typedParser = (eu.artist.postmigration.nfrvt.lang.tsl.ui.contentassist.antlr.internal.InternalTSLParser) parser;
			typedParser.entryRulePatternCatalogue();
