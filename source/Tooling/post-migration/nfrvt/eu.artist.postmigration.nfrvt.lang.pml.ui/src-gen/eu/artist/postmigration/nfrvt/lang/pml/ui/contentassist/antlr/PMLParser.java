...
* generated by Xtext
*/
package eu.artist.postmigration.nfrvt.lang.pml.ui.contentassist.antlr;
...
public class PMLParser extends AbstractContentAssistParser {
	...
	@Override
	protected eu.artist.postmigration.nfrvt.lang.pml.ui.contentassist.antlr.internal.InternalPMLParser createParser() {
		eu.artist.postmigration.nfrvt.lang.pml.ui.contentassist.antlr.internal.InternalPMLParser result = new eu.artist.postmigration.nfrvt.lang.pml.ui.contentassist.antlr.internal.InternalPMLParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getApplicationMeasurementAccess().getAlternatives(), "rule__ApplicationMeasurement__Alternatives");
					...
					put(grammarAccess.getMeasurementModelAccess().getGroup(), "rule__MeasurementModel__Group__0");
					put(grammarAccess.getObservationAccess().getGroup(), "rule__Observation__Group__0");
					put(grammarAccess.getObservationAccess().getGroup_5(), "rule__Observation__Group_5__0");
					put(grammarAccess.getObservationAccess().getGroup_6(), "rule__Observation__Group_6__0");
					put(grammarAccess.getObservationAccess().getGroup_10(), "rule__Observation__Group_10__0");
					put(grammarAccess.getObservationAccess().getGroup_10_1(), "rule__Observation__Group_10_1__0");
					put(grammarAccess.getDataPointMeasurementAccess().getGroup(), "rule__DataPointMeasurement__Group__0");
					put(grammarAccess.getDataPointMeasurementAccess().getGroup_8(), "rule__DataPointMeasurement__Group_8__0");
					put(grammarAccess.getDataPointMeasurementAccess().getGroup_9(), "rule__DataPointMeasurement__Group_9__0");
					put(grammarAccess.getDataPointMeasurementAccess().getGroup_13(), "rule__DataPointMeasurement__Group_13__0");
					put(grammarAccess.getTimeSeriesMeasurementAccess().getGroup(), "rule__TimeSeriesMeasurement__Group__0");
					put(grammarAccess.getTimeSeriesMeasurementAccess().getGroup_8(), "rule__TimeSeriesMeasurement__Group_8__0");
					put(grammarAccess.getTimeSeriesMeasurementAccess().getGroup_9(), "rule__TimeSeriesMeasurement__Group_9__0");
					put(grammarAccess.getTimeSeriesMeasurementAccess().getGroup_14(), "rule__TimeSeriesMeasurement__Group_14__0");
					put(grammarAccess.getTimeSeriesMeasurementAccess().getGroup_16(), "rule__TimeSeriesMeasurement__Group_16__0");
					put(grammarAccess.getBenchmarkMeasurementAccess().getGroup(), "rule__BenchmarkMeasurement__Group__0");
					put(grammarAccess.getBenchmarkMeasurementAccess().getGroup_8(), "rule__BenchmarkMeasurement__Group_8__0");
					put(grammarAccess.getBenchmarkMeasurementAccess().getGroup_9(), "rule__BenchmarkMeasurement__Group_9__0");
					put(grammarAccess.getBenchmarkMeasurementAccess().getGroup_10(), "rule__BenchmarkMeasurement__Group_10__0");
					put(grammarAccess.getBenchmarkMeasurementAccess().getGroup_11(), "rule__BenchmarkMeasurement__Group_11__0");
					put(grammarAccess.getBenchmarkMeasurementAccess().getGroup_15(), "rule__BenchmarkMeasurement__Group_15__0");
					put(grammarAccess.getTimeValuePairAccess().getGroup(), "rule__TimeValuePair__Group__0");
					put(grammarAccess.getSimpleWorkloadAccess().getGroup(), "rule__SimpleWorkload__Group__0");
					...
					put(grammarAccess.getMeasurementModelAccess().getImportsAssignment_1(), "rule__MeasurementModel__ImportsAssignment_1");
					put(grammarAccess.getMeasurementModelAccess().getObservationsAssignment_2(), "rule__MeasurementModel__ObservationsAssignment_2");
					put(grammarAccess.getObservationAccess().getToolNameAssignment_1(), "rule__Observation__ToolNameAssignment_1");
					put(grammarAccess.getObservationAccess().getDateTimeAssignment_4(), "rule__Observation__DateTimeAssignment_4");
					put(grammarAccess.getObservationAccess().getLevelAssignment_5_2(), "rule__Observation__LevelAssignment_5_2");
					put(grammarAccess.getObservationAccess().getMeasurementTypeAssignment_6_2(), "rule__Observation__MeasurementTypeAssignment_6_2");
					put(grammarAccess.getObservationAccess().getMeasurementsAssignment_10_0(), "rule__Observation__MeasurementsAssignment_10_0");
					put(grammarAccess.getObservationAccess().getMeasurementsAssignment_10_1_1(), "rule__Observation__MeasurementsAssignment_10_1_1");
					put(grammarAccess.getDataPointMeasurementAccess().getNameAssignment_1(), "rule__DataPointMeasurement__NameAssignment_1");
					put(grammarAccess.getDataPointMeasurementAccess().getPropertyAssignment_4(), "rule__DataPointMeasurement__PropertyAssignment_4");
					put(grammarAccess.getDataPointMeasurementAccess().getContextAssignment_7(), "rule__DataPointMeasurement__ContextAssignment_7");
					put(grammarAccess.getDataPointMeasurementAccess().getWorkloadAssignment_8_2(), "rule__DataPointMeasurement__WorkloadAssignment_8_2");
					put(grammarAccess.getDataPointMeasurementAccess().getConfidenceAssignment_9_2(), "rule__DataPointMeasurement__ConfidenceAssignment_9_2");
					put(grammarAccess.getDataPointMeasurementAccess().getValueAssignment_12(), "rule__DataPointMeasurement__ValueAssignment_12");
					put(grammarAccess.getDataPointMeasurementAccess().getInfoAssignment_13_2(), "rule__DataPointMeasurement__InfoAssignment_13_2");
					put(grammarAccess.getTimeSeriesMeasurementAccess().getNameAssignment_1(), "rule__TimeSeriesMeasurement__NameAssignment_1");
					put(grammarAccess.getTimeSeriesMeasurementAccess().getPropertyAssignment_4(), "rule__TimeSeriesMeasurement__PropertyAssignment_4");
					put(grammarAccess.getTimeSeriesMeasurementAccess().getContextAssignment_7(), "rule__TimeSeriesMeasurement__ContextAssignment_7");
					put(grammarAccess.getTimeSeriesMeasurementAccess().getWorkloadAssignment_8_2(), "rule__TimeSeriesMeasurement__WorkloadAssignment_8_2");
					put(grammarAccess.getTimeSeriesMeasurementAccess().getConfidenceAssignment_9_2(), "rule__TimeSeriesMeasurement__ConfidenceAssignment_9_2");
					put(grammarAccess.getTimeSeriesMeasurementAccess().getValuesAssignment_13(), "rule__TimeSeriesMeasurement__ValuesAssignment_13");
					put(grammarAccess.getTimeSeriesMeasurementAccess().getValuesAssignment_14_1(), "rule__TimeSeriesMeasurement__ValuesAssignment_14_1");
					put(grammarAccess.getTimeSeriesMeasurementAccess().getInfoAssignment_16_2(), "rule__TimeSeriesMeasurement__InfoAssignment_16_2");
					put(grammarAccess.getBenchmarkMeasurementAccess().getNameAssignment_1(), "rule__BenchmarkMeasurement__NameAssignment_1");
					put(grammarAccess.getBenchmarkMeasurementAccess().getPropertyAssignment_4(), "rule__BenchmarkMeasurement__PropertyAssignment_4");
					put(grammarAccess.getBenchmarkMeasurementAccess().getProviderAssignment_7(), "rule__BenchmarkMeasurement__ProviderAssignment_7");
					put(grammarAccess.getBenchmarkMeasurementAccess().getServiceAssignment_8_2(), "rule__BenchmarkMeasurement__ServiceAssignment_8_2");
					put(grammarAccess.getBenchmarkMeasurementAccess().getTestAssignment_9_2(), "rule__BenchmarkMeasurement__TestAssignment_9_2");
					put(grammarAccess.getBenchmarkMeasurementAccess().getWorkloadAssignment_10_2(), "rule__BenchmarkMeasurement__WorkloadAssignment_10_2");
					put(grammarAccess.getBenchmarkMeasurementAccess().getConfidenceAssignment_11_2(), "rule__BenchmarkMeasurement__ConfidenceAssignment_11_2");
					put(grammarAccess.getBenchmarkMeasurementAccess().getValueAssignment_14(), "rule__BenchmarkMeasurement__ValueAssignment_14");
					put(grammarAccess.getBenchmarkMeasurementAccess().getInfoAssignment_15_2(), "rule__BenchmarkMeasurement__InfoAssignment_15_2");
					put(grammarAccess.getTimeValuePairAccess().getDateTimeAssignment_0(), "rule__TimeValuePair__DateTimeAssignment_0");
					put(grammarAccess.getTimeValuePairAccess().getValueAssignment_2(), "rule__TimeValuePair__ValueAssignment_2");
					put(grammarAccess.getSimpleWorkloadAccess().getActivityAssignment_0(), "rule__SimpleWorkload__ActivityAssignment_0");
					put(grammarAccess.getSimpleWorkloadAccess().getPatternAssignment_2(), "rule__SimpleWorkload__PatternAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			eu.artist.postmigration.nfrvt.lang.pml.ui.contentassist.antlr.internal.InternalPMLParser typedParser = (eu.artist.postmigration.nfrvt.lang.pml.ui.contentassist.antlr.internal.InternalPMLParser) parser;
