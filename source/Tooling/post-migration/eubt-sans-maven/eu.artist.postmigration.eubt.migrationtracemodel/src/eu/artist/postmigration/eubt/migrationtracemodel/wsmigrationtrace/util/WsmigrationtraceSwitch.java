 ...
 * @generated
 */
public class WsmigrationtraceSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WsmigrationtracePackage.TRACE: {
				Trace trace = (Trace)theEObject;
				T result = caseTrace(trace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WsmigrationtracePackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WsmigrationtracePackage.SOURCE_ELEMENT: {
			...
			case WsmigrationtracePackage.TARGET_ELEMENT: {
			...
			case WsmigrationtracePackage.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WsmigrationtracePackage.SOURCE_PARAMETER: {
			...
			case WsmigrationtracePackage.TARGET_PARAMETER: {
			...
			case WsmigrationtracePackage.NAMESPACE: {
