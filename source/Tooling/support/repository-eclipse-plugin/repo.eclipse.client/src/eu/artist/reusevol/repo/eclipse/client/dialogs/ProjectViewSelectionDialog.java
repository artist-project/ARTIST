...
public class ProjectViewSelectionDialog extends ElementTreeSelectionDialog {

	public static final int OPEN = 9999;
	private LocalRepositoryModel model = LocalRepositoryModel.getInstance();

	public ProjectViewSelectionDialog(Shell parent, ILabelProvider labelProvider,
			ITreeContentProvider contentProvider) {
		super(parent, labelProvider, contentProvider);

		setTitle("Select artefacts");
		setMessage("Select artefacts");
		setInput(model);
	}
