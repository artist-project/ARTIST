...
public class TreeLabelProvider extends LabelProvider {
	...
	private static final Image ARTEFACT = getdefaultImage(ISharedImages.IMG_OBJ_FILE);
	...
	public String getText(Object element) {
		...
		if (element instanceof RepoServer) {
			...
			String members = (count > 0) ? " (" + count + ")" : "";
			return tag + members;
		} else if (element instanceof RepoArtefact) {
			String artefact = ((RepoArtefact) element).getName();
			return artefact;
		}
