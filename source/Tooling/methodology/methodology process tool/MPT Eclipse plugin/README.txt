...
All required Java libraries are included within the distributed JAR of the plug-in, eu.artist.methodology.mpt.cheatsheet_1.0.0.201406041313.jar, located under folder 'dist'. 
