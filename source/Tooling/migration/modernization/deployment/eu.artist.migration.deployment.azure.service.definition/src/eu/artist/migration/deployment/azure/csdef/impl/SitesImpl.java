 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.azure.csdef.impl.SitesImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.azure.csdef.impl.SitesImpl#getSite <em>Site</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SitesImpl extends MinimalEObjectImpl.Container implements Sites {
	...
	protected EClass eStaticClass() {
		return AzureCSDefPackage.Literals.SITES;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, AzureCSDefPackage.SITES__GROUP);
		}
		return group;
	}
	...
	public EList<Site> getSite() {
		return getGroup().list(AzureCSDefPackage.Literals.SITES__SITE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AzureCSDefPackage.SITES__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case AzureCSDefPackage.SITES__SITE:
