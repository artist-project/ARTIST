 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.azure.csdef.impl.ConfigurationSettingsImpl#getSetting <em>Setting</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConfigurationSettingsImpl extends MinimalEObjectImpl.Container implements ConfigurationSettings {
	/**
	...
	protected EClass eStaticClass() {
		return AzureCSDefPackage.Literals.CONFIGURATION_SETTINGS;
	}
	...
	public EList<ConfigurationSetting> getSetting() {
		if (setting == null) {
			setting = new EObjectContainmentEList<ConfigurationSetting>(ConfigurationSetting.class, this, AzureCSDefPackage.CONFIGURATION_SETTINGS__SETTING);
		}
		return setting;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AzureCSDefPackage.CONFIGURATION_SETTINGS__SETTING:
