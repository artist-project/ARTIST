 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.azure.csdef.impl.EnvironmentImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnvironmentImpl extends MinimalEObjectImpl.Container implements Environment {
	...
	protected EClass eStaticClass() {
		return AzureCSDefPackage.Literals.ENVIRONMENT;
	}
	...
	public EList<Variable> getVariable() {
		if (variable == null) {
			variable = new EObjectContainmentEList<Variable>(Variable.class, this, AzureCSDefPackage.ENVIRONMENT__VARIABLE);
		}
		return variable;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AzureCSDefPackage.ENVIRONMENT__VARIABLE:
