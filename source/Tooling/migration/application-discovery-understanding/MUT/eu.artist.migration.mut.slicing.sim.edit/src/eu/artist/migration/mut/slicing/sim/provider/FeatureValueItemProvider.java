...
/**
 * This is the item provider adapter for a {@link eu.artist.migration.mut.slicing.sim.FeatureValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureValueItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimPackage.Literals.FEATURE_VALUE__FEATURE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimPackage.Literals.FEATURE_VALUE__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((FeatureValue)object).getValue();
