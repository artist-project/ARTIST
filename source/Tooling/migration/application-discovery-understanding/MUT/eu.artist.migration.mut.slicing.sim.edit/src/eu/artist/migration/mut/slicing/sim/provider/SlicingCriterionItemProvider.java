...
/**
 * This is the item provider adapter for a {@link eu.artist.migration.mut.slicing.sim.SlicingCriterion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SlicingCriterionItemProvider 
	 ...
	 * @generated
	 */
	public SlicingCriterionItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SlicingCriterion_element_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SlicingCriterion_element_feature", "_UI_SlicingCriterion_type"),
				 SimPackage.Literals.SLICING_CRITERION__ELEMENT,
				 true,
				 false,
				 true,
				 null,
