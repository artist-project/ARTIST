...
/**
 * Pattern-specific match representation of the eu.artist.migration.mut.cmg.j2ee.tagging.queries.security pattern,
 * to be used in conjunction with {@link SecurityMatcher}.
 * 
...
public abstract class SecurityMatch extends BasePatternMatch {
  private org.eclipse.uml2.uml.Class fClient;
  
  private static List<String> parameterNames = makeImmutableList("client");
  
  private SecurityMatch(final org.eclipse.uml2.uml.Class pClient) {
  ...
  public List<String> parameterNames() {
    return SecurityMatch.parameterNames;
  ...
  @Override
  public SecurityMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SecurityMatch)) { // this should be infrequent
    	if (obj == null)
    		return false;
    ...
    SecurityMatch other = (SecurityMatch) obj;
  ...
  @Override
  public SecurityQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SecurityMatch newEmptyMatch() {
   ...
   * 
   */
  public static SecurityMatch newMutableMatch(final org.eclipse.uml2.uml.Class pClient) {
   ...
   * 
   */
  public static SecurityMatch newMatch(final org.eclipse.uml2.uml.Class pClient) {
    return new Immutable(pClient);
    
  }
  
  private static final class Mutable extends SecurityMatch {
  ...
  private static final class Immutable extends SecurityMatch {
