...
import eu.artist.migration.mmc.structures.Component;
...
import eu.artist.migration.mmc.structures.UmlElement;
...
public class MetricCalculator {
	...
	public List<Component> getMetrics(String folderPath, int type) throws Exception{// type 1 java 2 cshap
	...
	public List<Component> getMetricsByComponent(HashMap<String, List<String>> classFiles, List<String> srcPaths, int type) throws Exception{// type 1 java 2 cshap
