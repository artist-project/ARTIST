package eu.artist.migration.mut.componentmodelgenerator.lob.tagging.taggers;
...
import eu.artist.migration.mut.componentmodelgenerator.lob.tagging.queries.ASPNETControlMatch;
import eu.artist.migration.mut.componentmodelgenerator.lob.tagging.queries.ASPNETControlMatcher;
import eu.artist.migration.mut.componentmodelgenerator.lob.tagging.queries.ServiceApplicationMatch;
import eu.artist.migration.mut.componentmodelgenerator.lob.tagging.queries.ServiceApplicationMatcher;
import eu.artist.migration.mut.componentmodelgenerator.lob.tagging.queries.UIMatch;
import eu.artist.migration.mut.componentmodelgenerator.lob.tagging.queries.UIMatcher;
import eu.artist.migration.mut.componentmodelgenerator.lob.tagging.queries.WebPartMatch;
import eu.artist.migration.mut.componentmodelgenerator.lob.tagging.queries.WebPartMatcher;
import eu.artist.migration.mut.componentmodelgenerator.lob.tagging.queries.util.ASPNETControlProcessor;
import eu.artist.migration.mut.componentmodelgenerator.lob.tagging.queries.util.ServiceApplicationProcessor;
import eu.artist.migration.mut.componentmodelgenerator.lob.tagging.queries.util.UIProcessor;
import eu.artist.migration.mut.componentmodelgenerator.lob.tagging.queries.util.WebPartProcessor;
...
public class MSSharePointTagger {
	...
	private static final String GENERIC_PROFILE = "platform:/plugin/eu.artist.migration.mut.componentmodelgenerator.profiles/profiles/Generic.profile.uml";
	private static final String MS_SHAREPOINT_PROFILE = "platform:/plugin/eu.artist.migration.mut.componentmodelgenerator.profiles/profiles/MicrosoftSharePoint.profile.uml";
