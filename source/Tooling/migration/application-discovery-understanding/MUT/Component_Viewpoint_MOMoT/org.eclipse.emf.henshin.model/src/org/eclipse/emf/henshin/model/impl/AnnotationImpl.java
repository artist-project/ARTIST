...
public class AnnotationImpl extends ModelElementImpl implements Annotation {
	...
	protected EClass eStaticClass() {
		return HenshinPackage.Literals.ANNOTATION;
	}
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HenshinPackage.ANNOTATION__KEY, oldKey, key));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HenshinPackage.ANNOTATION__VALUE, oldValue, value));
	}
