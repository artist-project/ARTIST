...
public class WrapAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected WrapSwitch<Adapter> modelSwitch =
		new WrapSwitch<Adapter>() {
			@Override
			public Adapter caseWSynchronizer(WSynchronizer object) {
				return createWSynchronizerAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseWLink(WLink object) {
				return createWLinkAdapter();
			}
			@Override
			public Adapter caseWValue(WValue object) {
				return createWValueAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.henshin.wrap.WSynchronizer <em>WSynchronizer</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.henshin.wrap.WObject <em>WObject</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.henshin.wrap.WMember <em>WMember</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.henshin.wrap.WLink <em>WLink</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.henshin.wrap.WValue <em>WValue</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
