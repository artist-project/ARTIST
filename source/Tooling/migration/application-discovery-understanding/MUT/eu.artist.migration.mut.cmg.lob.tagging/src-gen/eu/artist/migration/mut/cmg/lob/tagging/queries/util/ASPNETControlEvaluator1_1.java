...
/**
 * A xbase xexpression evaluator tailored for the eu.artist.migration.mut.cmg.lob.tagging.queries.ASPNETControl pattern.
 */
@SuppressWarnings("all")
public class ASPNETControlEvaluator1_1 implements IMatchChecker {
  /**
   * The raw java code generated from the xbase xexpression by xtext.
   */
  private Boolean evaluateXExpressionGenerated(final String supname) {
    boolean _equals = Objects.equal(supname, "BaseUserControl");
