...
public class ServiceApplicationMatcher extends BaseMatcher<ServiceApplicationMatch> {
  ...
  public ServiceApplicationMatch newMatch(final org.eclipse.uml2.uml.Class pSub, final org.eclipse.uml2.uml.Class pSup) {
    return new ServiceApplicationMatch.Immutable(pSub, pSup);
  ...
  protected ServiceApplicationMatch tupleToMatch(final Tuple t) {
    try {
    	return new ServiceApplicationMatch.Immutable((org.eclipse.uml2.uml.Class) t.get(POSITION_SUB), (org.eclipse.uml2.uml.Class) t.get(POSITION_SUP));	
  ...
  protected ServiceApplicationMatch arrayToMatch(final Object[] match) {
    try {
    	return new ServiceApplicationMatch.Immutable((org.eclipse.uml2.uml.Class) match[POSITION_SUB], (org.eclipse.uml2.uml.Class) match[POSITION_SUP]);
  ...
  protected ServiceApplicationMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new ServiceApplicationMatch.Mutable((org.eclipse.uml2.uml.Class) match[POSITION_SUB], (org.eclipse.uml2.uml.Class) match[POSITION_SUP]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
