...
/**
 * Pattern-specific match representation of the eu.artist.migration.mut.cmg.lob.tagging.queries.ASPNETControl pattern, 
 * to be used in conjunction with {@link ASPNETControlMatcher}.
 * 
...
public abstract class ASPNETControlMatch extends BasePatternMatch {
  private org.eclipse.uml2.uml.Class fSub;
  
  private static List<String> parameterNames = makeImmutableList("sub");
  
  private ASPNETControlMatch(final org.eclipse.uml2.uml.Class pSub) {
    this.fSub = pSub;
  ...
  public List<String> parameterNames() {
    return ASPNETControlMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ASPNETControlMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    ASPNETControlMatch other = (ASPNETControlMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return ASPNETControlMatcher.querySpecification().getPattern();
  ...
  @SuppressWarnings("all")
  static final class Mutable extends ASPNETControlMatch {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends ASPNETControlMatch {
