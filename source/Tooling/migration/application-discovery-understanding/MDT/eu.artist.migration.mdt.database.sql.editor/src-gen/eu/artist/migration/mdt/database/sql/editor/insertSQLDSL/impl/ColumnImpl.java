 ...
 * <ul>
 *   <li>{@link eu.artist.migration.mdt.database.sql.editor.insertSQLDSL.impl.ColumnImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ColumnImpl extends MinimalEObjectImpl.Container implements Column
{
  ...
  {
    return InsertSQLDSLPackage.Literals.COLUMN;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InsertSQLDSLPackage.COLUMN__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case InsertSQLDSLPackage.COLUMN__VALUE:
        return getValue();
    }
