 ...
 * <ul>
 *   <li>{@link eu.artist.migration.mdt.database.sql.editor.insertSQLDSL.impl.DatabaseImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DatabaseImpl extends MinimalEObjectImpl.Container implements Database
{
  ...
  {
    return InsertSQLDSLPackage.Literals.DATABASE;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InsertSQLDSLPackage.DATABASE__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case InsertSQLDSLPackage.DATABASE__VALUE:
        return getValue();
    }
