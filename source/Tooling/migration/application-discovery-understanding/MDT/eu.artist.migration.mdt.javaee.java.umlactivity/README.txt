...
USER MANUAL
-----------
- See the section 3.1.5.5('User manual') of the deliverable 'Components for Model Discovery
from Legacy Technologies' of the ARTIST project website (artist-project.eu).
