...
•	Provide the set of results which comprises a) The evaluation of the maturity of the application including textual and graphical results ,b) A set of High level recommendations on how to perform the migration, c)A MAT report including the results of the assessment and a set of migration goals
...
This version provides several metrics and graphical representation of the maturity level analyzing different areas : Technical, Business, Processes.

Known issues: 

Some functionalities still missing: Results generation, access securization.
Some graphical representations are not properly displayed.


Expected functionality in next versions

Refinement of the maturity calculation and creation of a report for the end-users

Creation of a Migration Goal model

Include secure access to the application

Link to access the application

http://54.196.142.179:8080/ArtistEva 
