 ...
 *******************************************************************************/
package eu.artist.premigration.tft.mpt.api;
...
import eu.artist.premigration.tft.mpt.model.AnswerListContainer;
import eu.artist.premigration.tft.mpt.model.GlobalVariable;
import eu.artist.premigration.tft.mpt.model.Result;
import eu.artist.premigration.tft.mpt.model.Component;
...
public enum RuleEngine {
	 ...
	 */
	public void setRuleFile(File ruleFile) throws Exception {
		try {
	 ...
	 */
	public void fireRules(List<GlobalVariable> globals) throws Exception {
		StatefulKnowledgeSession ksession = kbase.newStatefulKnowledgeSession();
		ksession.insert(MigrationGoalsContainer.INSTANCE.getMigrationGoals());
		ksession.insert(AnswerListContainer.INSTANCE.getAnswerList());
	...
	private KnowledgeBase readKnowledgeBase(File ruleFile) throws Exception {
			//Bundle bundle = Platform.getBundle("eu.artist.premigration.tft.tft");
			//Class<?> c = bundle.loadClass("org.drools.KnowledgeBase");
	...
	/**
	 * Returns the TFT {@link TFTcomponent}s loaded from the TFT report
	 * 
	 * @return A {@link} list of {@link TFTcomponent}s
	 */
