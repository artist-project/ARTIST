...
<head>
<title>Hadoop NNBench Reports</title>
						...
						<div class="block-content collapse in">
							<div class="span12">
								<div id="rootwizard">
									<div class="navbar">
										<div class="navbar-inner">
											<div class="container">
												<ul>
													<li><a href="#tab1" data-toggle="tab">Statistical Analysis</a></li>
								...
								<div class="row-fluid">
									...
									<div class="block-content collapse in">
										<div class="span3">
											<div class="chart" >${avg_exec_time_open_read}</div>
											<div class="chart-bottom-heading">
												<span class="label label-info">Average Execution Time for Open/Read</span>

											</div>
										</div>
										<div class="span3">
											<div class="chart" >${avg_exec_time_delete}</div>
											<div class="chart-bottom-heading">
												<span class="label label-info">Average Execution Time for Delete</span>
											...
											<div class="chart" >${avg_exec_time_delete}</div>
											<div class="chart-bottom-heading">
												<span class="label label-info">Average Execution Time for Write</span>
									...
									<div class="block-content collapse in">
										<div class="span3">
											<div class="chart" data-percent=${average}>${total_avg_time}</div>
											<div class="chart-bottom-heading">
												<span class="label label-info">Total Average Execution Time</span>
