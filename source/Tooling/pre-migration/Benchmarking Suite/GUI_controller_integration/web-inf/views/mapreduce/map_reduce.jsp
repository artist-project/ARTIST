        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
					...
					<li class="active"><a href="map_reduce"><i class="icon-chevron-right"></i>Map-Reduce</a></li>
                    ...
                    <div class="row-fluid section">
                        ...
                        <div class="block">
                            ...
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Map-Reduce Benchmarking</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <div id="rootwizard">
										...
										<form:form commandName="mapreduce" id="form2" enctype="multipart/form-data" name="myForm" cssClass="form-horizontal">
                                          <div class="tab-content">
                                            
                                            
											<jsp:include page="map_reduceform.jsp" />
