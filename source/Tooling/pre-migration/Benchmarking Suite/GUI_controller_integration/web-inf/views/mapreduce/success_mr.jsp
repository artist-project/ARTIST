				...
				<div class="row-fluid">
					...
					<div class="block">
						<div class="navbar navbar-inner block-header">
							<div class="muted pull-left">Statistics for MrBench</div>
					...
					<div class="block-content collapse in">
						<div class="span3">
							...
							<div class="chart-bottom-heading">
								<span class="label label-info">Maps</span>

							</div>
						</div>
						<div class="span3">
							<div class="chart" data-percent="${Reduces}">
								${Reduces}
							</div>
							<div class="chart-bottom-heading">
								<span class="label label-info">Reduces
								</span>

							</div>
						</div>
						<div class="span3">
							<div class="chart" data-percent="${DataLines}">
								${DataLines}
							</div>
							<div class="chart-bottom-heading">
								<span class="label label-info">DataLines
									</span>
						...
						<div class="span3">
							<div class="chart"
								 data-percent="${AvgTime}">
								${AvgTime}
							</div>
							<div class="chart-bottom-heading">
								<span class="label label-info">AvgTime (ms)</span>
