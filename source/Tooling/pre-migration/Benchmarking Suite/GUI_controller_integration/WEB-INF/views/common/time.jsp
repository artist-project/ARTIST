	...
	<div class="tab-pane" id="tab2">
		<fieldset>
			<div class="control-group">
				...
				<div class="controls">
					<form:input class="input-xlarge focused" onclick="ds_sh(this);"
						onkeypress="return isNumeric(event)" id="focusedInput" type="text"
						value="" path="date" name="centenary" />
				</div>
				<table class="ds_box controls" cellpadding="0" cellspacing="0"
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input class="input-xlarge focused"
						...
						value="" path="time" name="centenary" />
				</div>
			</div>


			<div class="control-group">
				<label class="control-label" for="focusedInput">Centenary</label>

				<div class="controls">
					<form:input class="input-xlarge focused"
						onkeypress="return isNumeric(event)" id="focusedInput" type="text"
						value="" path="centenary" name="centenary" />
				</div>
			</div>
