...
<head>
<title>Hadoop Teragen-Terasort Reports</title>
						...
						<div class="block-content collapse in">
							<div class="span12">
								...
								<div class="row-fluid">
									...
									<div class="block-content collapse in">
										<div class="span3">
											<div class="chart" data-percent=${average}>${overall_thr}</div>
											<div class="chart-bottom-heading">
												<span class="label label-info">Metric 1</span>
TERAGEN
											</div>
										</div>
									...
									<div class="block-content collapse in">
										<div class="span3">
											<div class="chart" data-percent=${average}>${over_avg}</div>
											<div class="chart-bottom-heading">
												<span class="label label-info">Metric 1</span>
				...
				<table class="table table-striped table-bordered table-hover">
											...
											<tr>
												<TH>Test Number</th>
												<TH>Execution time In</th>
												<TH>Execution time Out</th>
												<TH>Execution time Val</th>
												<TH>Date</th>
											</tr>
											<c:forEach items="${threads}" var="current">
												...
												<tr>
													...
													<td><c:out value="${current.exectime_in}" />
													<td><c:out value="${current.exectime_out}" />
													<td><c:out value="${current.exectime_val}" />
