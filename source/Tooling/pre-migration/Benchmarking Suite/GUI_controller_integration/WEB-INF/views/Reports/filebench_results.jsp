					...
					<div class="block">
						...
						<div class="span3">
							...
							<div class="chart-bottom-heading">
								<span class="label label-info">Average Ops/sec</span>

							</div>
						</div>
						<div class="span3">
							<div class="chart">${over_avgn}</div>
							<div class="chart-bottom-heading">
								<span class="label label-info">Average Mb/sec</span>

							</div>
						</div>
						<div class="span3">
							<div class="chart">${over_avgm}</div>
							<div class="chart-bottom-heading">
								<span class="label label-info">Average Latency</span>
						...
						<div class="span3">
							...
							<div class="chart-bottom-heading">
								<span class="label label-info">Service Efficiency first Metric
									Description</span>

							</div>
						</div>
							<div class="span3">
							<div class="chart" data-percent="${f_george1}">${f_george1}</div>
							<div class="chart-bottom-heading">
								<span class="label label-info">Service Efficiency second Metric
									Description</span>

							</div>
						</div>
							<div class="span3">
							<div class="chart" data-percent="${f_george2}">${f_george2}</div>
							<div class="chart-bottom-heading">
								<span class="label label-info">Service Efficiency third Metric
									Description</span>
				...
				<table class="table table-striped table-bordered table-hover">
											...
											<c:forEach items="${CloudProvider}" var="current">
												...
												<tr>
													...
													<td><c:out value="${current.Ops}" />
													<td><c:out value="${current.OpsPerSecond}" />
													<td><c:out value="${current.ReadWrite}" />
													<td><c:out value="${current.MbPerSecond}" />
													<td><c:out value="${current.CpuOperations}" />
													<td><c:out value="${current.Latency}" />
