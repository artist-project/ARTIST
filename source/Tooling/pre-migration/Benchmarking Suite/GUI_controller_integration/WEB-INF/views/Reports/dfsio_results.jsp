...
<head>
<title>Hadoop TestDFSIO Reports</title>
			...
			<div class="span9" id="content">
				...
				<div class="row-fluid">
					...
					<div class="block-content collapse in">
						<div class="span3">
							<div class="chart">${over_avg_2}</div>
							<div class="chart-bottom-heading">
								<span class="label label-info">Read Overall Average
					...
					<div class="block-content collapse in">
						<div class="span3">
							...
							<div class="chart-bottom-heading">
								<span class="label label-info">Write Average Overall
									Throughtput</span>
