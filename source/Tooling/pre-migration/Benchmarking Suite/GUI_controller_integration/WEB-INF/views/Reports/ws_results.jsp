...
<head>
<title>Web Serving Reports</title>
			...
			<div class="span9" id="content">
				...
				<div class="row-fluid">
					...
					<div class="block-content collapse in">
						<div class="span3">
							<div class="chart">${overall_thr}</div>
							<div class="chart-bottom-heading">
								<span class="label label-info">Overall
									Throughput(ops/sec)</span>
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tr>
						<TH>Test Number</th>
						<TH>Started Requests</th>
						<TH>Succeded Request</th>
						<TH>Total Requests</th>
						<TH>Failed Requests</th>
						<TH>Done Requests</th>
						<TH>Errored Requests</th>
						<TH>Date</th>
					</tr>
					<c:forEach items="${threads}" var="current">
						...
						<tr>
							...
							<td><c:out value="${current.threads}" />
							<td><c:out value="${current.succededreq}" />
							<td><c:out value="${current.totalreq}" />
							<td><c:out value="${current.failedreq}" />
							<td><c:out value="${current.donereq}" />
							<td><c:out value="${current.erroredreq}" />
