		...
		<div class="row-fluid">
			...
			<div class="span9" id="content">
				...
				<div class="row-fluid">
					...
					<div class="block">
						<div class="navbar navbar-inner block-header">
							<div class="muted pull-left">Statistics for Load</div>
					...
					<div class="block-content collapse in">
						<div class="span3">
							<div class="chart"
								data-percent="${Overall_Throughput}">
								${Overall_Throughput}
							</div>
							<div class="chart-bottom-heading">
								<span class="label label-info">Overall Throughput(ops/sec)</span>

							</div>
						</div>
						<div class="span3">
							<div class="chart" data-percent="${LoadOVERALLRunTime}">
								${LoadOVERALLRunTime}
							</div>
							<div class="chart-bottom-heading">
								<span class="label label-info">Overall Run Time (Seconds)
								</span>

							</div>
						</div>
						<div class="span3">
							<div class="chart" data-percent="${LoadInsertAverageLatency}">
								${LoadInsertAverageLatency}
							</div>
							<div class="chart-bottom-heading">
								<span class="label label-info">Load Average Latency
									(us)</span>
						...
						<div class="span3">
							<div class="chart"
								 data-percent="${LoadInsertReturn-LoadInsertOperations}">
								${LoadInsertReturn-LoadInsertOperations}
							</div>
							<div class="chart-bottom-heading">
								<span class="label label-info">Load Returns (Errors)</span>
				...
				<div class="row-fluid">
					...
					<div class="block">
						<div class="navbar navbar-inner block-header">
							<div class="muted pull-left">Statistics for Transactions</div>
					...
					<div class="span3">
						<div class="chart" data-percent="${OVERALLRunTime}">
							${OVERALLRunTime}
						</div>
						<div class="chart-bottom-heading">
							<span class="label label-info">Update-Read OverAll RunTime
								(ms)</span>
					...
					<div class="span3">
						<div class="chart"
							 data-percent="${OVERALLThroughput}">
							${OVERALLThroughput}
						</div>
						<div class="chart-bottom-heading">
							<span class="label label-info">Update Read Throughput(ops/sec) </span>
						</div>
					</div>
					<div class="span3">
						<div class="chart" data-percent="${UPDATEAverageLatency}">
							${UPDATEAverageLatency}
						</div>
						<div class="chart-bottom-heading">
							<span class="label label-info">Update Average Latency(us)</span>
						</div>
					</div>
				...
				<div class="block">
					<div class="navbar navbar-inner block-header">
						<div class="muted pull-left">Statistics for Transactions 2</div>


					</div>
					<div class="span3">
						<div class="chart" data-percent="${READAverageLatency}">
							${READAverageLatency}
						</div>
						<div class="chart-bottom-heading">
							<span class="label label-info">Read Average Latency(us)</span>
						</div>
					</div>
					<div class="span3">
						<div class="chart" data-percent="${Total_Errors}">
							${Total_Errors}
						</div>
						<div class="chart-bottom-heading">
							<span class="label label-info">Total Transactions Returns(Errors)</span>
						</div>
					</div>
