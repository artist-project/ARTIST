                    ...
                    <div class="row-fluid section">
                        ...
                        <div class="block">
                            ...
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Database Benchmarking</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <div id="rootwizard">
										...
										<form:form commandName="dbentity" id="form2" enctype="multipart/form-data" name="myForm" cssClass="form-horizontal">
                                          <div class="tab-content">
                                            
                                            
											<jsp:include page="dbform.jsp" />
